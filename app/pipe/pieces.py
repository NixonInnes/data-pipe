...
class PipePieces:
    ...
    combiners: PipePiecesCollection = PipePiecesCollection(builtin_combiners, imported_combiners)
    inlets: PipePiecesCollection = PipePiecesCollection(builtin_inlets, imported_inlets)
    outlets: PipePiecesCollection = PipePiecesCollection(builtin_outlets, imported_outlets)
    transformers: PipePiecesCollection = PipePiecesCollection(builtin_transformers, imported_transformers)
